...
/// <summary>
/// Defines a single interactive action rendered inside the <c>CloudDataGrid</c> toolbar or on a row.
///
/// <para><b>Types</b></para>
/// <list type="bullet">
///   <item><see cref="CloudDataGridActionType.Link"/> — renders an <c>&lt;a&gt;</c> navigating to <see cref="Href"/>.</item>
///   <item><see cref="CloudDataGridActionType.Button"/> — renders a <c>&lt;button&gt;</c> that fires <see cref="OnClicked"/>.</item>
///   <item><see cref="CloudDataGridActionType.Element"/> — renders a toggle button; when activated the button slot is replaced
...
/// </list>
/// </summary>
public class CloudDataGridAction
{
    /// <summary>Stable identifier used to track state and surfaced in event args.</summary>
    public required string Key { get; set; }

    /// <summary>How the action is rendered and behaves. Defaults to <see cref="CloudDataGridActionType.Button"/>.</summary>
    public CloudDataGridActionType Type { get; set; } = CloudDataGridActionType.Button;
    ...
    /// <summary>
    /// Destination URL for <see cref="CloudDataGridActionType.Link"/> actions.
    /// </summary>
    public string? Href { get; set; }

    /// <summary>
    /// Anchor <c>target</c> attribute (e.g. <c>_blank</c>, <c>_parent</c>).
    /// Only used for <see cref="CloudDataGridActionType.Link"/> actions.
    /// </summary>
    ...
    /// Only used for <see cref="CloudDataGridActionType.Element"/> actions.
    /// </summary>
    public RenderFragment? ChildContent { get; set; }

    /// <summary>
    /// Called when the user cancels an active <see cref="CloudDataGridActionType.Element"/> action
    ...
    /// <summary>
    /// Called by the header when an <see cref="CloudDataGridActionType.Element"/> action is activated.
    ...
    /// <list type="bullet">
    ///   <item><see cref="CloudDataGridActionType.Button"/> — on click.</item>
    ///   <item><see cref="CloudDataGridActionType.Link"/> — not fired (browser navigation handles it).</item>
    ///   <item><see cref="CloudDataGridActionType.Element"/> — not fired (use <see cref="ChildContent"/> interactions).</item>
    /// </list>
    /// <para>
    ...
    /// </para>
    /// </summary>
    public EventCallback<CloudDataGridActionEventArgs> OnClicked { get; set; }
}
