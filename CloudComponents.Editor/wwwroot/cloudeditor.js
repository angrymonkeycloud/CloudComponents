...
// Implements the CloudEditor contenteditable engine: command execution,
...
export function create(dotNetRef, editorElement, options) {
    return new CloudEditorController(dotNetRef, editorElement, options);
}

class CloudEditorController {
    #dotNetRef;
    #editor;
    #options;
    #savedRange = null;
    ...
    #exec(command, value) {
        ...
        catch (error) { console.warn(`CloudEditor: command '${command}' failed.`, error); }
