...
/// </summary>
public partial class CloudTextEditor : ComponentBase, IAsyncDisposable
{
    private const string ModulePath = "./_content/AngryMonkey.CloudComponents.TextEditor/cloudeditor.js";

    private IJSObjectReference? _module;
    private IJSObjectReference? _controller;
    private DotNetObjectReference<CloudTextEditor>? _selfRef;
    private ElementReference _contentElement;

    private CloudTextEditorSelectionState _selectionState = new();
    ...
    [Parameter] public CloudTextEditorToolbarOptions Toolbar { get; set; } = new();
    ...
    /// </summary>
    [Parameter] public Func<CloudTextEditorFileUpload, Task<string?>>? ImageUploadHandler { get; set; }
    ...
    [JSInvokable]
    public async Task UpdateSelectionStateAsync(CloudTextEditorSelectionState state)
    {
